# HyCanvas Contributor License Agreement

Version 1.0

Thank you for contributing to HyCanvas, a product of HyScaler, the trading name of NetTantra Technologies (India) Private Limited ("HyScaler", "we", "us"). HyScaler is a trading name, not a separate legal entity, so this Agreement and every right granted below run to NetTantra Technologies (India) Private Limited itself.

This Contributor License Agreement ("Agreement") clarifies the intellectual-property rights in your contributions. It protects you, HyScaler, and users of HyCanvas, and it is what allows HyScaler to keep HyCanvas freely available under the Elastic License 2.0 while also offering separate commercial licenses.
...
- "You" means the individual accepting this Agreement, or the legal entity on whose behalf it is accepted.
- "Contribution" means any original work of authorship, including code, documentation, designs, and assets, that you intentionally submit to HyCanvas in any form (pull request, patch, issue attachment, or otherwise).
...
- You are legally entitled to grant the licenses above. If your employer has rights in your Contributions, you have your employer's permission, or your employer has waived its rights, or your employer has accepted this Agreement for you.
- Each Contribution is your original creation, or you have identified any third-party material and its license terms in the Contribution.
- Your Contributions are provided as is, without warranties of any kind, except as stated here.
