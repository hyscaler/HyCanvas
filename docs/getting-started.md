...
![The HyCanvas sign-in page](images/login.png)
...
![The Create menu with preset formats](images/create-design.png)
...
![The editor on a blank Instagram-post design](images/editor.png)
