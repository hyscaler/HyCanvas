...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: `Shift+${MOD}+V`, label: "Paste in place" },
      { keys: `Alt+${MOD}+C`, label: "Copy style" },
      { keys: `Alt+${MOD}+V`, label: "Paste style" },
      { keys: `${MOD}+D`, label: "Duplicate" },
      { keys: `${MOD}+A`, label: "Select all" },
      { keys: `${MOD}+G`, label: "Group" },
      { keys: `Shift+${MOD}+G`, label: "Ungroup" },
      { keys: "1–0", label: "Set opacity (type 1–2 digits)" },
      { keys: "Delete", label: "Delete selection" },
      { keys: "Esc", label: "Cancel drag / clear selection" },
    ],
  },
  {
    title: "Arrange",
  ...
  },
  {
    ...
    items: [
      ...
      { keys: "Alt+hover", label: "Measure to element / page edges" },
    ],
  },
  {
    title: "Zoom",
