...
export const STICKERS: Sticker[] = [
  ...
  { id: "crownband", label: "Crown", category: "Fun", svg: svg('<path d="M14 76 22 30l20 20 8-34 8 34 20-20 8 46Z" fill="#f59e0b"/><rect x="14" y="76" width="72" height="10" fill="#d97706"/>') },
  ...
  { id: "leafcurl", label: "Leaf", category: "Fun", svg: svg('<path d="M84 12C40 12 16 40 16 80c0 0 0 8 4 8 40 0 68-28 68-72 0-4-4-4-4-4Z" fill="#22c55e"/>') },
  ...
  // --- More symbols ---
  { id: "mappin", label: "Map pin", category: "Symbols", svg: svg('<path d="M50 6c18 0 30 12 30 30 0 22-30 56-30 56S20 58 20 36C20 18 32 6 50 6Z" fill="#ef4444"/><circle cx="50" cy="34" r="11" fill="#ffffff"/>') },
